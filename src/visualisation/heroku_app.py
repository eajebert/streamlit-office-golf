...
server = (
    app.server
)  # this line will only be used by Heroku server and not used on local
...
#     global df
#     bat_df = (
#         df.groupby(["bowling_team", "batsman"])["batsman_runs"]
#         .sum()
#         .reset_index()
#         .copy()
#     )
...
#         y="batsman_runs",
#         color="batsman_runs",
#         labels={"bowling_team": "Teams", "batsman_runs": "Runs Scored"},
#         height=400,
#         width=500,
#         title="Runs Scored by " + player + " against all teams",
...
#     global df
#     bol_df = df[
#         ~df["dismissal_kind"].isin(["retired hurt", "run out", "obstructing the field"])
#     ].copy()
#     bol_df = (
#         bol_df.groupby(["batting_team", "bowler"])["is_wicket"]
#         .sum()
#         .reset_index()
#         .copy()
#     )
...
#         values="is_wicket",
#         names="batting_team",
#         labels={"batting_team": "Teams", "is_wicket": "Wickets_taken"},
#         height=400,
#         width=500,
#         title="Wickets taken by " + player + " against all teams",
#         template="plotly_dark",
#     )
#     fig.update_layout({"paper_bgcolor": "#282828", "plot_bgcolor": "#282828"})
...
#                 dcc.Graph(
#                     id="wicketsTaken"
#                 )  # graph only requireds unique id in our case
#             ],
#             style={
#                 "width": "45%",
#                 "position": "fixed",
...
# app.layout = html.Div(
#     id="main_div", children=[dropdown_box, Graphs], style=main_div_style
# )
